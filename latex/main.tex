...
\def\phone{(651) 706-6713}
\def\email{pattisona@carleton.edu}
\def\github{alipatti}
\def\website{alipatti.com}
...
%
% \begin{itemize}
% 	\item Completed selective high-school math program culminating in six semesters of set theory, vector calculus, linear algebra, and differential equations at the University of Minnesota.
% \end{itemize}
